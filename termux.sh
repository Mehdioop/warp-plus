...
install() {
    ...
    if wget https://github.com/bepass-org/warp-plus/releases/download/v1.2.5/warp-plus_android-arm64.zip &&
...
install_arm() {
    ...
    WARP_URL="https://github.com/bepass-org/warp-plus/releases/download/v1.2.5/warp-plus_linux-$ARCH.zip"
...
menu() {
    ...
    echo ""
    echo -e "${yellow}❤️Github.com/${cyan}Mehdioop${yellow}/warp-plus❤️${rest}"
    echo -e "${purple}*********************************${rest}"
