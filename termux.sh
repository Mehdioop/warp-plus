...
install() {
    ...
    if wget https://github.com/Mehdioop/warp-plus/releases/latest/download/warp-plus_android-arm64.zip &&
...
install_arm() {
    ...
    WARP_URL="https://github.com/Mehdioop/warp-plus/releases/latest/download/warp-plus_linux-$ARCH.zip"
